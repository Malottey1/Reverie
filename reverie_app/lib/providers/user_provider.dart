...
class UserProvider with ChangeNotifier {
  ...
  Future<void> fetchUserInfo(int userId) async {
    final url = 'https://reverie.newschateau.com/api/reverie/get_user_info.php';
  ...
  Future<void> checkIfVendor(int userId) async {
    final url = 'https://reverie.newschateau.com/api/reverie/check_vendor.php';
  ...
  Future<void> fetchVendorOrders(int vendorId) async {
    final url = 'https://reverie.newschateau.com/api/reverie/fetch_vendor_orders.php';
...
Future<void> fetchVendorDeliveredOrders(int vendorId) async {
  try {
    final response = await http.post(
      Uri.parse('https://reverie.newschateau.com/api/reverie/fetch_vendor_delivered_orders.php'),
      headers: {'Content-Type': 'application/json'},
      body: json.encode({'vendor_id': vendorId}),
    );
